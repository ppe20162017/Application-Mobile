...
public class CreateBdVergers extends SQLiteOpenHelper {
    ...
    private static final String COL_PRODUTEUR = "NOMPRODUCTEUR";
    private static final String CREATE_BDD = "CREATE TABLE " + TABLE_VERGERS + " ("+COL_ID+" INTEGER PRIMARY KEY AUTOINCREMENT,"
            ...
            + COL_COMMUNE + " TEXT NOT NULL," + COL_PRODUTEUR + " TEXT NOT NULL);";
    public CreateBdVergers(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
